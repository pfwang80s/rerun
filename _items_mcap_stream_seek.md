...
- 负责人：TBD；提交：TBD；备注：2026-08-13 产品批准新增本项，以解除MCAP-023 final plan与MCAP-025 authority对同一sealed physical evidence的ownership cycle；同日批准lower object binding从首次bound probe沿019→023 evidence chain贯穿、upper/lower不可分、同一one-shot owner绑定profile/registry/budgets及MCAP-088专属artifact bridge的设计修订；不新增工作项，总数仍90，完成后再实施MCAP-032。
